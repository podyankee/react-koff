import s from './CartForm.module.sass';
	...
	<form className={s.form}>
		...
		<fieldset className={s.fieldsetRadio}>
			...
			<label className={s.radio}>
				<input className={s.radioInput} type='radio' name='deliveryType' value='delivery' />
				Доставка
			</label>
			<label className={s.radio}>
				<input className={s.radioInput} type='radio' name='deliveryType' value='pickup' />
				Самовывоз
			</label>
		</fieldset>
		<fieldset className={s.fieldsetRadio}>
